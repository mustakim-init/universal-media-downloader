...
"""A custom QLineEdit that includes a search icon and placeholder text. did not add it to make the code shorter."""

# Update the QCustomCheckBox class with the fixed paintEvent method
"""A custom checkbox with a checkmark icon and hover effects. also did not add it to make the code shorter."""

class CustomHeaderView(QHeaderView):
    """Custom sort indicator for the download table with custom styles."""
